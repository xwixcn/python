...
function showcasedata()
{
	$("#buttontype").click(function() {
		...
		$.getJSON(url, function(json) {
			var tr = $("<tr><td>patternStr</td><td>patternCode</td><td>treeCode</td>"
					+ "<td>md5</td><td>name</td><td>OPT</td></tr>")
			tr.appendTo($("table"));
			tr.attr("id", "tr" + 0);
			$("table").show();
			$.each(json, function(index, content) {
					...
					$.easypage({'contentclass':'contentlist','navigateid':'navigatediv','everycount':2,'navigatecount':5});	
		});
	});
