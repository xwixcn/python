...
if __name__=="__main__":
    ...
    import time
    #print urllib2.urlopen('http://192.168.23.75:10001/job_start/sentences/115').read()
    #time.sleep(20)
    print urllib2.urlopen('http://192.168.23.75:10000/job_start/singlecompare/115').read()
    time.sleep(1)
    #print urllib2.urlopen('http://192.168.23.75:10000/job_stop/singlecompare/115').read()
    #time.sleep(20)
    #print redis.get_somekeyvalues("sentences__110","")
    #test={'1':'22'}
